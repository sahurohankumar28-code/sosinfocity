...
const caseStudiesData = [
  {
    ...
    subtitle: "Machine learning integration targeting early mechanical fault diagnosis, successfully dropping enterprise system downtime by 35%.",
    img: "images/case_study_1.jpg",
    challenge: "The enterprise experienced frequent and costly system downtime due to unanticipated mechanical failures. The lack of predictive maintenance capabilities resulted in reactive problem-solving, causing significant operational disruptions. Maintenance costs were escalating, and the organization needed a proactive approach to equipment management.",
    solution: "Development and deployment of an ML-powered Intelligent Enforcement Management System that transformed the organization's approach to maintenance. The solution provided real-time monitoring, predictive analytics, and automated alert systems for early fault detection. Machine learning algorithms continuously improved accuracy, enabling proactive intervention before failures occurred.",
    results: [
  ...
  },
  {
    ...
    subtitle: "AI-powered threat detection and continuous security perimeter telemetry optimized across multi-node state municipal systems.",
    img: "images/case_study_3.jpg",
    challenge: "The state's existing network infrastructure faced significant challenges with outdated security protocols that couldn't keep pace with evolving cyber threats. Fragmented monitoring systems created blind spots, and the inability to detect sophisticated attacks in real-time left critical municipal services vulnerable. Legacy systems also struggled with the growing volume of network traffic, causing performance bottlenecks across multiple departments.",
    solution: "SOS Infocity deployed a comprehensive multi-layered security framework that revolutionized the state's network defense capabilities. The solution combined AI-driven threat detection algorithms with continuous perimeter telemetry monitoring, creating an intelligent security ecosystem. Automated incident response protocols were implemented to neutralize threats instantly, while a centralized command center provided unified visibility across all municipal nodes.",
    results: [
  ...
  },
  {
    ...
    subtitle: "Deploying high-efficiency zero-trust infrastructure layers for over 200+ active cross-regional corporate branch offices seamlessly.",
